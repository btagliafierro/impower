...
The objective introduced in [**RO2**](../index.md#ro2) will be achieved by developing new software within the open-source DualSPHysics code ([Domínguez et al. 2022](#Dominguez2022)). DualSPHysics is a CFD solver based on the Smoothed Particle Hydrodynamics method (SPH) ([Violeau and Rogers 2016](#Violeau_2016)) for simulating fluid mechanics and is particularly suitable for simulating free-surface and violent flows. New functionalities to simulate wind-blade interaction and power control systems will be embedded using a multiphysics set of functions (known as library), called Project Chrono ([Tasora et al. 2016](#Chrono_2016)), used as an interface. Specifically, the following tools will be developed to comply with **BoW 1**:

<div style="background-color: #fff0e6; padding: 20px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-bottom: 20px; border-left: 5px solid #ff9800;">
  <h3 style=" margin-top: 0;">Tools to be Developed</h3>
  <ul style="list-style-type: none; padding-left: 0;">
    <li style="margin-bottom: 10px;">
      <strong style="color: #ff9800;">Tool 1:</strong> An aerodynamic solver for wind-blade interaction (in WP3)
    </li>
    <li style="margin-bottom: 10px;">
      <strong style="color: #ff9800;">Tool 2:</strong> Two open-loop control functions for simulating blade pitch adjustment and generator absorbed power (in WP3)
    </li>
  </ul>
</div>
...
<p><strong>Duration:</strong> Months M1-M12 (4 person-months) <span style="color: #00BFFF; font-weight: bold;">(Current: M1)</span><br>
...
<div style="background-color: #e0e0e0; border-radius: 5px; overflow: hidden; margin-bottom: 10px; position: relative; height: 10px;">
  <div style="width: 100%; background-color: #8A2BE2; height: 10px; position: absolute; left: 0;"></div>
  <div style="width: 4.17%; background-color: #00BFFF; height: 10px; position: absolute; left: 0; z-index: 1;"></div>
  <div style="width: 4.17%; border-right: 2px solid white; height: 10px; position: absolute; left: 0; z-index: 2;"></div>
</div>
<p><strong>Duration:</strong> Months M1-M24 (6 person-months) <span style="color: #00BFFF; font-weight: bold;">(Current: M1)</span><br>
...
<p>The software considered for engineering the new features is completely open-source, and all novel implementations will be released as such, including supporting documentation. Notably, the source code of DualSPHysics is redistributed under the terms of the GNU Lesser General Public License (LGPL), which is most favorable for attracting industry usage.</p>
